...
public class MagicalBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:magical_block")
	public static final Block block = null;
	public MagicalBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1848);
	}
