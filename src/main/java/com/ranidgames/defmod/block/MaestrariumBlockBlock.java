...
public class MaestrariumBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:maestrarium_block")
	public static final Block block = null;
	public MaestrariumBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("maestrarium_block");
		}
