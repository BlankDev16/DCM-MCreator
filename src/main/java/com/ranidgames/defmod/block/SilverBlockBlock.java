...
public class SilverBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:silver_block")
	public static final Block block = null;
	public SilverBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1449);
	}
