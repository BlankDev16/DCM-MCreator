...
public class GalenaBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:galena_block")
	public static final Block block = null;
	public GalenaBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1323);
	}
