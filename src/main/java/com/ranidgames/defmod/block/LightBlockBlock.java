...
public class LightBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:light_block")
	public static final Block block = null;
	public LightBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 888);
	}
