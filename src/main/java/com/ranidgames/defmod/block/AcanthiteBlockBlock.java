...
public class AcanthiteBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:acanthite_block")
	public static final Block block = null;
	public AcanthiteBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1071);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("acanthite_block");
		}
