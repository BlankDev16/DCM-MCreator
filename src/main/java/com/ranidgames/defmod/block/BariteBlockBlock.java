...
public class BariteBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:barite_block")
	public static final Block block = null;
	public BariteBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1092);
	}
