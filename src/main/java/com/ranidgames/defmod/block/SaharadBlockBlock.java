...
public class SaharadBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:saharad_block")
	public static final Block block = null;
	public SaharadBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1575);
	}
