...
public class GagusatusBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:gagusatus_block")
	public static final Block block = null;
	public GagusatusBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1000);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gagusatus_block");
		}
