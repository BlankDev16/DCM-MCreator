...
public class OrerumBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:orerum_block")
	public static final Block block = null;
	public OrerumBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1722);
	}
