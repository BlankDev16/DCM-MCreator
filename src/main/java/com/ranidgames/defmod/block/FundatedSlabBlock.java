...
public class FundatedSlabBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:fundated_slab")
	public static final Block block = null;
	public FundatedSlabBlock(DefinitiveContentModModElements instance) {
		super(instance, 249);
	}
