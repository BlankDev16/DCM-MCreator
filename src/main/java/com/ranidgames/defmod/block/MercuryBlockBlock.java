...
public class MercuryBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:mercury_block")
	public static final Block block = null;
	public MercuryBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1533);
	}
