...
public class CrescendoBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:crescendo_block")
	public static final Block block = null;
	public CrescendoBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 242);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crescendo_block");
		}
