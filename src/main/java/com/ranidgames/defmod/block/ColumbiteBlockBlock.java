...
public class ColumbiteBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:columbite_block")
	public static final Block block = null;
	public ColumbiteBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1302);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("columbite_block");
		}
