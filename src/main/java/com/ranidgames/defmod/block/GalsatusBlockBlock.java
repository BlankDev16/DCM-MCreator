...
public class GalsatusBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:galsatus_block")
	public static final Block block = null;
	public GalsatusBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1596);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("galsatus_block");
		}
