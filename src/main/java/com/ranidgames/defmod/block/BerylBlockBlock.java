...
public class BerylBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:beryl_block")
	public static final Block block = null;
	public BerylBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1134);
	}
