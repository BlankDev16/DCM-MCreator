...
public class ChalcopyriteBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:chalcopyrite_block")
	public static final Block block = null;
	public ChalcopyriteBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1218);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chalcopyrite_block");
		}
