...
public class PowderBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:powder_block")
	public static final Block block = null;
	public PowderBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 237);
	}
