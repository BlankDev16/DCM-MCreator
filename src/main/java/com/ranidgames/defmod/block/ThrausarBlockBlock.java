...
public class ThrausarBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:thrausar_block")
	public static final Block block = null;
	public ThrausarBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1659);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("thrausar_block");
		}
