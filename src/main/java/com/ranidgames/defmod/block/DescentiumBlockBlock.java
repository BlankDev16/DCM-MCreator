...
public class DescentiumBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:descentium_block")
	public static final Block block = null;
	public DescentiumBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("descentium_block");
		}
