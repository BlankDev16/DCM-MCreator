...
public class ChalcociteBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:chalcocite_block")
	public static final Block block = null;
	public ChalcociteBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1197);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chalcocite_block");
		}
