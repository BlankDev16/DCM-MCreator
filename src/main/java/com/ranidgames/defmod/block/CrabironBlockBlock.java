...
public class CrabironBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:crabiron_block")
	public static final Block block = null;
	public CrabironBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1743);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crabiron_block");
		}
