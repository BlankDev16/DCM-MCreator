...
public class FundousBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:fundous_block")
	public static final Block block = null;
	public FundousBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 232);
	}
