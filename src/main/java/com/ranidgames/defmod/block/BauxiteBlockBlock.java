...
public class BauxiteBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:bauxite_block")
	public static final Block block = null;
	public BauxiteBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1113);
	}
