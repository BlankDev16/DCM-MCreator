...
public class FundatedLogBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:fundated_log")
	public static final Block block = null;
	public FundatedLogBlock(DefinitiveContentModModElements instance) {
		super(instance, 245);
	}
