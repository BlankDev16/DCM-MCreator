...
public class AscentiumBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:ascentium_block")
	public static final Block block = null;
	public AscentiumBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 241);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ascentium_block");
		}
