...
public class CinnabarBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:cinnabar_block")
	public static final Block block = null;
	public CinnabarBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1260);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cinnabar_block");
		}
