...
public class UltraniumBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:ultranium_block")
	public static final Block block = null;
	public UltraniumBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 234);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ultranium_block");
		}
