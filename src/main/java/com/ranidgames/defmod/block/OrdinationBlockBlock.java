...
public class OrdinationBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:ordination_block")
	public static final Block block = null;
	public OrdinationBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 979);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ordination_block");
		}
