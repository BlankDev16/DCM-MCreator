...
public class FundatedFenceBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:fundated_fence")
	public static final Block block = null;
	public FundatedFenceBlock(DefinitiveContentModModElements instance) {
		super(instance, 250);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("fundated_fence");
		}
