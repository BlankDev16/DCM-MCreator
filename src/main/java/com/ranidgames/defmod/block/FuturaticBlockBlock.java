...
public class FuturaticBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:futuratic_block")
	public static final Block block = null;
	public FuturaticBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1029);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("futuratic_block");
		}
