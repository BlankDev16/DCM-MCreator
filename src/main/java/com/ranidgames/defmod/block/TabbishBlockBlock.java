...
public class TabbishBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:tabbish_block")
	public static final Block block = null;
	public TabbishBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1701);
	}
