...
public class BorniteBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:bornite_block")
	public static final Block block = null;
	public BorniteBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1155);
	}
