...
public class OldacusBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:oldacus_block")
	public static final Block block = null;
	public OldacusBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1050);
	}
