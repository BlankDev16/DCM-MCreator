...
public class ThirstushBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:thirstush_block")
	public static final Block block = null;
	public ThirstushBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1764);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("thirstush_block");
		}
