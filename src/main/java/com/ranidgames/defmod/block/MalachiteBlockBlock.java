...
public class MalachiteBlockBlock extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:malachite_block")
	public static final Block block = null;
	public MalachiteBlockBlock(DefinitiveContentModModElements instance) {
		super(instance, 1365);
	}
