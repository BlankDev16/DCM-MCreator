...
import com.ranidgames.defmod.particle.RainbowPartParticle;
...
import com.ranidgames.defmod.entity.renderer.RosariusRenderer;
import com.ranidgames.defmod.DefinitiveContentModModElements;

@DefinitiveContentModModElements.ModElement.Tag
public class RosariusEntity extends DefinitiveContentModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.4f, 0.3f)).build("rosarius").setRegistryName("rosarius");
	public RosariusEntity(DefinitiveContentModModElements instance) {
		super(instance, 307);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RosariusRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3407872, -13369600, new Item.Properties().group(DMCMiscItemGroup.tab))
				.setRegistryName("rosarius_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 12;
			setNoAI(false);
			setCustomName(new StringTextComponent("Definitive Silverfish"));
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			DefinitiveBlogGunItem.shoot(this, target);
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 3; ++l) {
					...
					world.addParticle(RainbowPartParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}
