...
public class UnotrueArmorItem extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:unotrue_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("definitive_content_mod:unotrue_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("definitive_content_mod:unotrue_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("definitive_content_mod:unotrue_armor_boots")
	public static final Item boots = null;
	public UnotrueArmorItem(DefinitiveContentModModElements instance) {
		super(instance, 4);
	}
