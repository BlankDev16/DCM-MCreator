...
public class GreenusArmorItem extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:greenus_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("definitive_content_mod:greenus_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("definitive_content_mod:greenus_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("definitive_content_mod:greenus_armor_boots")
	public static final Item boots = null;
	public GreenusArmorItem(DefinitiveContentModModElements instance) {
		super(instance, 5);
	}
