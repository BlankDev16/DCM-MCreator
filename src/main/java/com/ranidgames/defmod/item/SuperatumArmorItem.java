...
public class SuperatumArmorItem extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:superatum_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("definitive_content_mod:superatum_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("definitive_content_mod:superatum_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("definitive_content_mod:superatum_armor_boots")
	public static final Item boots = null;
	public SuperatumArmorItem(DefinitiveContentModModElements instance) {
		super(instance, 12);
	}
