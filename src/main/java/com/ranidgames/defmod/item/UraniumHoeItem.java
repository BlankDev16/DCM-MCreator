...
public class UraniumHoeItem extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:uranium_hoe")
	public static final Item block = null;
	public UraniumHoeItem(DefinitiveContentModModElements instance) {
		super(instance, 137);
	}
