...
public class PretiosaArmorItem extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:pretiosa_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("definitive_content_mod:pretiosa_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("definitive_content_mod:pretiosa_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("definitive_content_mod:pretiosa_armor_boots")
	public static final Item boots = null;
	public PretiosaArmorItem(DefinitiveContentModModElements instance) {
		super(instance, 16);
	}
