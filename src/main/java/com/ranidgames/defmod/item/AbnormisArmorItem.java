...
public class AbnormisArmorItem extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:abnormis_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("definitive_content_mod:abnormis_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("definitive_content_mod:abnormis_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("definitive_content_mod:abnormis_armor_boots")
	public static final Item boots = null;
	public AbnormisArmorItem(DefinitiveContentModModElements instance) {
		super(instance, 14);
	}
