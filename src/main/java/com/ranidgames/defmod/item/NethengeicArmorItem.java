...
public class NethengeicArmorItem extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:nethengeic_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("definitive_content_mod:nethengeic_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("definitive_content_mod:nethengeic_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("definitive_content_mod:nethengeic_armor_boots")
	public static final Item boots = null;
	public NethengeicArmorItem(DefinitiveContentModModElements instance) {
		super(instance, 22);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(FantasysTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "definitive_content_mod:textures/models/armor/nethengeic_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("nethengeic_armor_helmet"));
