...
public class UraniumArmorItem extends DefinitiveContentModModElements.ModElement {
	@ObjectHolder("definitive_content_mod:uranium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("definitive_content_mod:uranium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("definitive_content_mod:uranium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("definitive_content_mod:uranium_armor_boots")
	public static final Item boots = null;
	public UraniumArmorItem(DefinitiveContentModModElements instance) {
		super(instance, 23);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{30, 70, 60, 30}[slot.getIndex()];
			}
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(UraniumShardItem.block));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(FantasysTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "definitive_content_mod:textures/models/armor/uranium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
